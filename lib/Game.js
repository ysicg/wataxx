...
const ply2color = require("./utils.js").ply2color
const pieceCounter = require("./utils.js").pieceCounter
const checkTermination = require("./utils.js").checkTermination
...
class Game {
	...
	set move(m) { 
		...
		this.termination = checkTermination({...this.states[this.ply]}, pieceCounter({...this.states[this.ply]})) //needs optimizing big time
	}
}
